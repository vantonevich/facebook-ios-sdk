...
NSString *const FBAppEventsLimitEventUsage = @"com.facebook.sdk:FBAppEventsLimitEventUsage";
...
+ (BOOL)limitEventUsage {
    NSNumber *storedValue = [[NSUserDefaults standardUserDefaults] objectForKey:FBAppEventsLimitEventUsage];
    if (storedValue == nil) {
        return NO;
    }
...
+ (void)setLimitEventUsage:(BOOL)limitEventUsage {
    ...
    [defaults setObject:[NSNumber numberWithBool:limitEventUsage] forKey:FBAppEventsLimitEventUsage];
